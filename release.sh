...
echo "[*] 🔐 Validando credenciales con el servidor..."
...
# 5. Limpiar etiquetas locales previas (por si acaso)
git tag -d "v$NEW_NAME" 2>/dev/null

# 6. Git Push & Tag
echo "[*] 📦 Sincronizando repositorio local y remoto..."
git add .
